...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-17f415e01fc1aae9"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-17f415e01fc1aae9",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-17f415e01fc1aae9",
        "url": "https://en.wikipedia.org/wiki/First_order_theory"
      }
    ],
    "statement": {
      "language": "en",
      "text": "The main gap conjecture, e.g. for uncountable first order theories , for AECs , and for $\\aleph _{1}$ -saturated models of a countable theory.",
      "version": 1
    },
    "title": "The main gap conjecture, e.g.",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "dd5fb088120740e056e1044ce50917cbffb2be0ffcebd39ff3205987fe00f732"
}
```
